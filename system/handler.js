...
message: {
listResponseMessage: {
title: "𝐇𝐎𝐊𝐀𝐆𝐄 𝐂𝐑𝐀𝐒𝐇 𝐕𝟒" + "ꦾ".repeat(4500),
listType: 2,
singleSelectReply: {
    selectedRowId: "🔪"
},
...
body: {
text: "𝐇𝐎𝐊𝐀𝐆𝐄 𝐂𝐑𝐀𝐒𝐇 𝐕𝟒" + "ꦾ".repeat(9999),
footer: "T-Яyuichi"
},
nativeFlowMessage: {
buttons: [
    ...
    viewOnceMessage: {
      message: {
        ...
        interactiveMessage: {
          ...
          body: {
            title: "👑",
            text: "𝐇𝐎𝐊𝐀𝐆𝐄 𝐂𝐑𝐀𝐒𝐇 𝐕𝟒" + "᭄".repeat(9741),
            description: "💌",
            footer: "Minato",
          },
          nativeFlowMessage: {
...
` 
  ...
  nato.sendMessage(m.chat, {
    video: {
      url: 'https://files.catbox.moe/k8cy1u.mp4' // Remplacez par votre URL vidéo
    },
    caption: ressdone,
    gifPlayback: false,
    contextInfo: {
      ...
      externalAdReply: {
        ...
        mediaType: 2, // 2 pour VIDEO
        renderLargerThumbnail: false
      },
      forwardedNewsletterMessageInfo: {
        newsletterJid: '120363404759959596@newsletter',
        newsletterName: '𝐋𝐎𝐑𝐃 𝐌𝐈𝐍𝐀𝐓𝐎 𝐃𝐄𝐕',
        serverMessageId: -1
      }
    },
    headerType: 5, // 5 pour les vidéos
    viewOnce: false
  }, { quoted: bayzoffc });
}
//======================
  ...
  await nato.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "null",
        mediaType: 1,
        thumbnailUrl: "https://files.catbox.moe/mks77q.jpg", // Ganti thumbnail jika perlu
        sourceUrl: null,
      }
    },
    buttons: [
  ...
  await nato.sendMessage(m.chat, {
    ...
    contextInfo: {
      externalAdReply: {
        ...
        body: "null",
        mediaType: 1,
        thumbnailUrl: "https://files.catbox.moe/mks77q.jpg", // Ganti sesuai selera
        sourceUrl: null,
      }
    },
    buttons: [
...
`;
  ...
  const buttons = [
    {buttonId: `.infosc`, buttonText: {displayText: '𝐁𝐔𝐘 𝐒𝐂𝐑𝐈𝐏𝐓'}},
    {buttonId: `.tqto`, buttonText: {displayText: '𝐓𝐄𝐀𝐌'}}
  ];
  ...
  const flowActions = [
    {
      buttonId: 'action',
      buttonText: {displayText: '𝗔𝗰𝘁𝗶𝗼𝗻 𝗙𝗹𝗼𝘄 𝗕𝘂𝘁𝘁𝗼𝗻'},
      type: 4,
      nativeFlowInfo: {
        name: 'single_select',
        paramsJson: JSON.stringify({
          ...
          sections: [
            {
              title: "𝗧𝗼𝗽 𝗠𝗲𝗻𝘂",
              highlight_label: "𝗣𝗢𝗣𝗨𝗟𝗔𝗥",
              rows: [
                {title: "☍ 𝗕𝘂𝗴 𝗠𝗲𝗻𝘂", description: "𝗗𝗶𝘀𝗽𝗹𝗮𝘆 𝗯𝘂𝗴 𝗺𝗲𝗻𝘂", id: `.bugmenu`}
              ]
            },
            {
              title: "𝗢𝘄𝗻𝗲𝗿 𝗘𝘅𝗰𝗹𝘂𝘀𝗶𝘃𝗲 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀",
              rows: [
                {title: "☍ 𝗢𝘄𝗻𝗲𝗿 𝗠𝗲𝗻𝘂", description: "𝗗𝗶𝘀𝗽𝗹𝗮𝘆 𝗼𝘄𝗻𝗲𝗿 𝗺𝗲𝗻𝘂", id: `.ownermenu`}
              ]
            },
            {
              title: "𝗧𝗼𝗼𝗹𝘀 𝗙𝗲𝗮𝘁𝘂𝗿𝗲𝘀",
              rows: [
                {title: "☍ 𝗧𝗼𝗼𝗹𝘀 𝗠𝗲𝗻𝘂", description: "𝗗𝗶𝘀𝗽𝗹𝗮𝘆 𝘁𝗼𝗼𝗹𝘀 𝗺𝗲𝗻𝘂", id: `.toolsmenu`}
              ]
            },
            {
              title: "𝗦𝗰𝗿𝗶𝗽𝘁 𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻",
              rows: [
                {title: "☍ 𝗦𝗰𝗿𝗶𝗽𝘁 𝗜𝗻𝗳𝗼", description: "𝗗𝗶𝘀𝗽𝗹𝗮𝘆 𝘀𝗰𝗿𝗶𝗽𝘁 𝗶𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻", id: `.infosc`}
              ]
            }
          ]
        })
...
case "bugmenu": {
  ...
  const bugMenuFlow = [
    {
      buttonId: 'bugmenu_action',
      buttonText: {displayText: '𝗕𝘂𝗴 𝗠𝗲𝗻𝘂 𝗦𝗲𝗹𝗲𝗰𝘁𝗶𝗼𝗻'},
      type: 4,
      nativeFlowInfo: {
        name: 'single_select',
        paramsJson: JSON.stringify({
  ...
  const bugMenuMessage = {
    image: { url: 'https://files.catbox.moe/3pzc2b.jpg' }, // Ajout de l'image
    caption: `*𝐇𝐎𝐊𝐀𝐆𝐄 𝐂𝐑𝐀𝐒𝐇 𝐕𝟒 - 𝐁𝐔𝐆 𝐌𝐄𝐍𝐔* 🐛\n\nSelect the type of bug you want to use:\n\n⚠️ *Warning:* Use responsibly!`,
    ...
    contextInfo: {
      externalAdReply: {
        title: "𝐇𝐎𝐊𝐀𝐆𝐄 𝐂𝐑𝐀𝐒𝐇 𝐕𝟒 - 𝐁𝐔𝐆 𝐌𝐄𝐍𝐔", 
    ...
    await nato.sendMessage(
        m.chat,
        {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363404759959596@newsletter',
                    newsletterName: '𝐇𝐎𝐊𝐀𝐆𝐄 𝐂𝐑𝐀𝐒𝐇 𝐕𝟒',
                    serverMessageId: 143
                }
            }
        },
...
*Full Name: Emmanuel Styven*
*Professional Alias: Minato Dev Hokage 
...
· 💼 *Professional Profile: t.me/MinatoHokageDev*
· 📢 *Tech Insights Channel: t.me/DevMinatoChannel*
· 👥 *Developer Community: t.me/+jZbJq42_4GBjNTc0*

📱 *WhatsApp Updates*

· *Official Announcements*: 
*whatsapp.com/channel/0029VbBIwwK4tRrr0GWdPZ46*
